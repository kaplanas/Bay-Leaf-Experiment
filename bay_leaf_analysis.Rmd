...
The predictions are surprisingly decent, although it's worth observing that this model is able to make somewhat stronger predictions than we're likely to be able to make with the real dataset.
